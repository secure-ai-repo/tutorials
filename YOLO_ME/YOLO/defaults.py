...
class argHandler(dict):
    ...
    def setDefaults(self):
        self.define('imgdir', 'C:\\Users\\mpole\\Dataset\\Xray\\img_sample\\', 'path to testing directory with images')
        self.define('binary', 'C:\\Users\\mpole\\TensorVision\\YOLO_ME\\YOLO\\net\\bin\\', 'path to .weights directory')
        self.define('config', 'C:\\Users\mpole\\TensorVision\\YOLO_ME\\cfg\\', 'path to .cfg directory')
        self.define('dataset', 'C:\\Users\\mpole\\Dataset\\Xray\\img_sample\\', 'path to dataset directory')
        self.define('labels', '', 'path to labels file')
        self.define('backup', 'C:\\Users\\mpole\\TensorVision\\YOLO_ME\\YOLO\\net\\ckpt\\', 'path to backup folder')
        self.define('summary', '', 'path to TensorBoard summaries directory')
        self.define('annotation', 'C:\\Users\\mpole\\Dataset\\Xray\\xml_sample\\', 'path to annotation directory')
        self.define('threshold', -0.1, 'detection threshold')
        self.define('model', 'C:\\Users\\mpole\\TensorVision\\YOLO_ME\\cfg\\yolov2_voc.cfg', 'configuration of choice')
